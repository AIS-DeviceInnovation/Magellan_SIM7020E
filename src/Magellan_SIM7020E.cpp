/*
Magellan_SIM7020E v1.1.0 NB-IoT Magellan Platform .
...
and supported only Magellan3 IoT Platform 
...
bool Magellan_SIM7020E::begin(){
  ...
  Serial.println();
  Serial.println(F("               AIS NB-IoT Magellan_SIM7020E V1.1.0"));
    ...
    if(count_error_token_post>=10)
     {
      ...
      Serial.println(F("Invalid Token"));
      ESP.restart();
      token_error_report=true;
     }
  } 
...
/*-------------------------------------
  ...
  -------------------------------------
*/
//------------------ Magellan_SIM7020E 3.0 Response Management --------
